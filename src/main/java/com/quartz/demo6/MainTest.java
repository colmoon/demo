...
public class MainTest {
	public static void main(String args[]) throws SchedulerException {
		...
		JobListener myJobListener = new MyJobListener("pickNewsJob");
		KeyMatcher<JobKey> keyMatcher = KeyMatcher.keyEquals(pickNewsJob.getKey());

		JobListener myJobListenerT = new MyJobListener("getHottestJob");
		KeyMatcher<JobKey> keyMatcherT = KeyMatcher.keyEquals(getHottestJob.getKey());
...
//		scheduler.getListenerManager().addJobListener(myJobListenerT, keyMatcherT);
